...
text_box.grid(row = 0, column = 0,columnspan = 8,padx=30, pady = 30)    # padx-->for left , pady means-->for top side
text_box.insert(0, "0")
#text_box.focus()
...
text_box2 = Entry(calc, justify=RIGHT,width=30,font="Times 16 bold")
text_box2.grid(row = 6, column = 0,columnspan = 8,padx=30, pady = 30)    # padx-->for left , pady means-->for top side
text_box2.insert(0, "0")
